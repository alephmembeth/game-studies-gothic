...
\enquote{\textsc{Orpheus} -- \uline{Übersicht}} beginnt mit einem zweiseitig beschriebenen karierten Blatt (mit der gewohnten Vierfachlochung und Marginalsteg).
Dem folgen zwei einseitig beschriebene Karoblätter sowie ein Blankoblatt.
Auf den ersten beiden Seiten -- also dem zweiseitig beschriebenen Blatt -- dominieren mit blauem Kugelschreiber gezeichnete Karten, neben denen es kleinere Skizzen und Stichpunkte gibt.
...
Dabei handelt es sich, in alphabetischer Reihenfolge der Titel, um \enquote{\uline{\textsc{Der rote Faden\,$\ldots$}}}, \enquote{\uline{Der Werdegang eines SC's}}, \enquote{\uline{\textsc{Orpheus -- Bewegungen}}}, \enquote{\uline{\textsc{Orpheus} -- Interface}}, \enquote{\textsc{Orpheus} -- Spielwelt/Gildensystem}, \enquote{\textsc{Orpheus} -- Spielwelt/Gildensystem V2} und \enquote{Zusammenfassung zum Orpheus-Konzept. \uline{Graphiken}}, sowie um die beiden titellosen Dokumente zur Kampfsteuerung sowie zu den Nicht-Spieler-Charakteren der verschiedenen Fraktionen.


% ORPHEUS – DOKUMENTE – ROTER FADEN %
Die Notizen zum \enquote{\uline{\textsc{rote[n] Faden}}} sind auf Blanko-Bögen festgehalten worden.
Die erste von insgesamt vier Seiten beinhaltet eine vertikal angelegte und nummerierte Liste, verfasst mit dem oben bereits angesprochenen ursprünglich wohl schwarzen Stift, der eher braun erscheint.
...
Die ersten drei Seiten sind überwiegend durch (numerische oder alphabetische) Aufzählungen organisert.
Die verbleibenden Seiten enthalten demgegenüber lose Notizen und Skizzen.


% ORPHEUS – DOKUMENTE – GILDENSYSTEM %
Bei \enquote{Spielwelt/Gildensystem} und \enquote{Spielwelt/Gildensystem V2} handelt es sich um zwei Fassungen eines ursprünglich auf Blanko-Papier entworfenen und dann mehrfach kopierten Formulars, das Felder für verschiedene Aspekte der unterschiedlichen Fraktionen enthält.
...
Im Wesentlichen ist das Dokument nach Gruppierungen gegliedert, deren Namen eingerahmt hervorgehoben werden, und von denen wir ein bis zwei pro Seite finden.
Darunter folgen -- durch einen Doppelpfeil getrennt -- zwei Spalten zur Auflistungen möglicher Gruppenmitglieder.

...
\enquote{\textsc{Orpheus} -- \uline{Übersicht}} beginnt mit einem zweiseitig beschriebenen kariertes Blatt (mit der gewohnten Vierfachlochung und Marginalsteg).
Dem folgen zwei einseitig beschriebene Karoblätter sowie ein Blankoblatt.
Auf den ersten beiden Seiten -- also dem zweiseitig beschriebenen Blatt -- dominieren Karten; daneben gibt es kleinere schematische Darstellungen und stichpunktartige Notizen.


%%% LESEZEICHEN %%%

Wenden wir uns jetzt den Dokumenten zu, die neben dem Konvolut \enquote{\textsc{Orpheus. B -- Scribbles}} erhalten sind.

...
Werfen wir als nächstes einen Blick auf diejenigen Abschnitte des Konvolts, die eigene Überschriften tragen.
Dabei folgen wir nicht der oben genannten Reihenfolge, sondern gehen alphabetisch vor.
...
Die Notizen zu \enquote{\textsc{Orpheus -- History}} sind auf einem zweiseitig beschriebenen Blatt mit karierten Lineatur verfasst (wie im oben genannten Fall mit Vierfachlochung sowie Marginalsteg auf der linken Seite).
Unter dem Titel finden wir eine fortlaufend nummerierte Liste mit neun Positionen.
Vereinzelt gibt es Ergänzungen links und rechts des eigentlichen Textes.
...
Mit dem blauen Kugelschreiber, der auch genutzt wurde, um die Überschrift schwungvoll zu unterstreichen, sind einige Ränder der Buchstaben nachgezogen, um dem Ganzen einen plastischen Anschein zu geben.
Mit dem gleichen Stift sind auch die nachfolgend untereinander notierten Stichpunkte geschrieben.
...
Wieder handelt es sich um ein kariertes Blatt mit Vierfachlochung und Marginalsteg.
Wieder ist der erste Teil des Titels mit einem ursprünglich wahrscheinlich schwarzen Stift geschrieben, wobei die Farbe inzwischen näher an Braue ist.
In diesem Fall ist das Wort \enquote{\textsc{Locations}} mit grünem Fineliner aufs Papier gebracht worden.
Das \enquote{\textsc{s}} ist mit einem blauen Kugelschreiber nachgezogen, mit dem wahrscheinlich auch die nachstehenden Stichpunkte verfasst worden sind, die etwa die oberen beiden Drittel der Seite füllen.

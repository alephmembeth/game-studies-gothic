...
\begin{itemize}
   ...
   \item \enquote{\uline{Roter Faden} II -- Die ersten Aufträge[,] \uline{Info} über Lager / $\leftarrow$ Gilden}
...
Den \enquote{\uline{Werdegang eines SC's}} finden wir auf einem beidseitig beschriebenen Blankobogen, wobei jede Seite eine eigene Überschrift trägt:

\begin{itemize}
   \item \enquote{\uline{Der Werdegang eines SC's}}
   \item \enquote{\uline{Werdegang eines SC's} -- II}
\end{itemize}

\noindent Die Vorderseite wird fast vollständig von einer nummerierten Liste gefüllt, abermals mit dem ursprünglich wohl schwarzen Stift verfasst.
...
Die spätere Fassung reduziert die Felder auf insgesamt zehn, ergänzt dasjenige für die \enquote{\textsc{Beziehungen} zu anderen Gilden} dafür aber um eine Liste von insgesamt 16 Parteien, so dass sich zu jeder die jeweilige Haltung notieren lässt.
...
Bei dem nicht näher betitelten Dokument zu den Nicht-Spieler-Charakteren in den verschiedenen Fraktionen handelt es sich um insgesamt neun Seiten auf dem bekannten karierten Papier.

...
Mit dem gleichen Stift sind auch die nachfolgend untereinander notierten Stichpunkte verfasst.
...
Das \enquote{\textsc{s}} am Ende ist mit einem blauen Kugelschreiber nachgezogen, mit dem wahrscheinlich auch die nachstehenden Stichpunkte verfasst worden sind, die etwa die oberen beiden Drittel der Seite füllen.
...
Die erste von insgesamt vier Seiten beinhaltet eine nummerierte Liste, verfasst mit dem oben bereits angesprochenen ursprünglich wohl schwarzen Stift.
...
Den \enquote{\uline{Werdegang eines SC's}} finden wir auf einem beidseitig beschriebenen Blankobogen.

...
\usepackage[natbib,notes,backend=biber]{biblatex-chicago}
   \bibliography{game_studies_gothic_manuscript_references}
\usepackage{booktabs}
...
Gleiches gilt meiner Meinung nach übrigens auch -- aber das soll an dieser Stelle nur eine Randbemerkung bleiben -- für die Kommunikation der Entwickler:innen.\footnote{An vielen Stellen profitiert die Forschung von dem erhalten gebliebenen Schriftverkehr vergangener Generationen. Dass ein Großteil dieses Schriftverkehrs heute elektronisch vonstattengeht und das Risiko birgt, für künftige Generationen unzugänglich zu werden, haben Errol Friedberg und Kollegen bereits Anfang des Jahrtausends in einer Zuschrift an \textit{Nature} angemahnt; \autocite[vgl.][]{friedberg_e_mail_2003}.}
...
Der erste Name, den das Projekt trug, war \textit{Orpheus}. % Mike fragen, woher der Name stammt.
...
Die zu \textit{Orpheus} vorliegenden Dokumente lassen sich -- etwas abweichend von der Sortierung im \textit{Gothic Archive} -- anhand einiger in ihnen enthaltener Titel grob gliedern. % Mike fragen, ob die Zusammenstellung so stimmt
...
\noindent die -- abgesehen von den Überschriften ihrer jeweiligen Abschnitte -- keine eigenen Titel tragen, sowie einige lose Notizen, die sich (neben den oben genannten Titeln \enquote{\textsc{History}}, \enquote{\textsc{Kreaturen}}, \enquote{\textsc{Locations}}, \enquote{\uline{Übersicht}} und \enquote{\uline{Aufträge}}) in einem Konvolut finden, dem ein Deckblatt mit der Aufschrift \enquote{\textsc{Orpheus. B -- Scribbles}} vorangestellt ist.\footnote{\autocite{orpheus_b_scribbles}. Das \enquote{B} mag hier ein Nummerierungselement darstellen. \enquote{Scribbles} sind im Englischen Kritzeleien oder Schmierereien. Damit wird aber auch, insbesondere im Medienbereich, die skizzenhafte und grobe Darstellung erster Ideen oder Entwürfe bezeichnet; \autocite[vgl.][S.~128]{seebohn_werbung_2011}.} % Mike fragen, worauf sich »B – Scribbles« bezieht
Einen visuellen Überblick über die einzelnen Dokumente geben \autoref{fig:orpheus_dokumente_1} und \autoref{fig:orpheus_dokumente_2} in \autoref{ch:anhang_abbildungen}.
Werfen wir im Folgenden zuerst einen kurzen Blick auf die Beschaffenheit der jeweiligen Dokumente, ehe wir uns ihrem Inhalt zuwenden.
...
Die Seitenorganisation ist nicht-linear und fragmentarisch; es finden sich zahlreiche Listen mit Aufzählungszeichen (Punkte, Striche, Pfeile, Nummern und Buchstaben) sowie Ergänzungen von späterer Hand.
...
Kommen wir als nächstes zu diejenigen Abschnitten des Konvolts, die eigene Überschriften tragen.
Dabei folgen wir nicht der oben genannten dokumentinternen Reihenfolge, sondern gehen alphabetisch vor.
Den Anfang machen entsprechend die \enquote{\uline{Aufträge}}, gefolgt von \enquote{\textsc{Orpheus -- History}}, \enquote{\textsc{Orpheus -- Kreaturen}}
\enquote{\textsc{Orpheus -- Locations}} sowie \enquote{\textsc{Orpheus} -- \uline{Übersicht}}.


% ORPHEUS – DOKUMENTE – AUFTRAEGE %
Bei den \enquote{\uline{Aufträge[n]}} handelt es sich um zwei Blankoseiten, die zunächst mit einem blauen Kugelschreiber beschrieben und später mit einem schwarzen Kugenschreiber ergänzt worden sind.
...
% ORPHEUS – DOKUMENTE – HISTORY %
Die Notizen zu \enquote{\textsc{Orpheus -- History}} stehen auf einem zweiseitig beschriebenen karierten Blatt (wieder mit Vierfachlochung und Marginalsteg).
Unter dem Titel finden wir eine fortlaufend nummerierte Liste mit neun Positionen, die verschiedene Stadien der Hintergrundgeschichte beschreiben.
Vereinzelt gibt es links und rechts davon Ergänzungen.
Auffällig ist außerdem die Akzentuierung zentraler Schlagworte durch Versalien und/oder Unterstreichungen.


% ORPHEUS – DOKUMENTE – KREATUREN %
Auch bei \enquote{\textsc{Orpheus -- Kreaturen}} handelt es sich um ein kariertes Blatt mit Vierfachlochung und Marginalsteg.
Der erste Teil des Titels ist geschrieben mit einem ursprünglich wahrscheinlich schwarzen Stift, vermutlich einem Fineliner, wobei die Farbe mittlerweile eher ins Braune tendiert.
Das Wort \enquote{\textsc{Kreaturen}} hingegen ist mit einem breiten roten Filzstift in gedrungenen Versalien verfasst.
Mit dem blauen Kugelschreiber, der auch genutzt wurde, um die Überschrift schwungvoll zu unterstreichen, sind einige Ränder der Buchstaben nachgezogen, um dem Ganzen einen plastischen Effekt zu geben.
Mit dem gleichen Stift sind auch die nachfolgend untereinander mit Spiegelstrichen notierten Stichpunkte verfasst.
Darunter, etwas nach dem ersten Drittel der Seite, folgt eine mit einem dunkleren Kugelschreiber mehrfach grob gezogene Trennlinie, der ein Nachtrag von späterer Hand folgt.


% ORPHEUS – DOKUMENTE – LOCATIONS %
\enquote{\textsc{Orpheus -- Locations}} sieht ganz ähnlich aus.
Wieder handelt es sich um ein entsprechend kariertes Blatt mit Vierfachlochung und Marginalsteg.
Wieder ist der erste Teil des Titels mit einem ursprünglich wahrscheinlich schwarzen Stift geschrieben, wobei die Farbe inzwischen näher an Brau ist.
In diesem Fall ist das Wort \enquote{\textsc{Locations}} mit grünem Fineliner aufs Papier gebracht worden.
Das \enquote{\textsc{s}} am Ende ist mit einem blauen Kugelschreiber nachgezogen, mit dem wahrscheinlich auch die darunter folgenden nummerierten Stichpunkte verfasst worden sind, die etwa die oberen beiden Drittel der Seite füllen.


% ORPHEUS – DOKUMENTE – ÜBERSICHT %
Die \enquote{\textsc{Orpheus} -- \uline{Übersicht}} beginnt mit einem zweiseitig beschriebenen karierten Blatt (mit der gewohnten Lochung und dem Steg).
Dem folgen zwei einseitig beschriebene Karoblätter sowie ein Blankoblatt.
Auf den ersten beiden Seiten -- also dem zweiseitig beschriebenen Blatt -- dominieren mit blauem Kugelschreiber gezeichnete Karten, neben denen kleinere Skizzen und Stichpunkte untergebracht sind.
Während die dritte Seite von einer schematischen Darstellung in gleichem Blau ausgefüllt wird, finden wir auf der vierten und fünften Seite nach Fraktionen gruppierte Listen, die mit dem von oben bereits bekannten schwarzen Fineliner verfasst sind, wobei es Nachträge mit Bleistift gibt.

Wenden wir uns als nächsten den übrigen Dokumenten zu, die neben dem Konvolut \enquote{\textsc{B -- Scribbles}} erhalten geblieben sind.
Dabei handelt es sich, wieder in alphabetischer Reihenfolge der Titel, um \enquote{\uline{\textsc{Der rote Faden\,$\ldots$}}}, \enquote{\uline{Der Werdegang eines SC's}}, \enquote{\uline{\textsc{Orpheus -- Bewegungen}}}, \enquote{\uline{\textsc{Orpheus} -- Interface}}, \enquote{\textsc{Orpheus} -- Spielwelt/Gildensystem}, \enquote{\textsc{Orpheus} -- Spielwelt/Gildensystem V2} und \enquote{Zusammenfassung zum Orpheus-Konzept. \uline{Graphiken}}, sowie um die beiden titellosen Dokumente zur Kampfsteuerung sowie zu den Nicht-Spieler-Charakteren.


% ORPHEUS – DOKUMENTE – ROTER FADEN %
Die Notizen zum \enquote{\uline{\textsc{rote[n] Faden}}} sind auf Blankobögen festgehalten worden.
Die insgesamt vier Seiten werden jeweils durch eigene Überschriften gegliedert.
Dabei handelt es sich um

\begin{itemize}
   \item \enquote{\uline{\textsc{Der rote Faden\,$\ldots$}}},
   \item \enquote{\uline{Roter Faden: Magische 15 Minuten}},
   \item \enquote{\uline{Roter Faden} II -- Die ersten Aufträge[,] \uline{Info} über Lager / $\leftarrow$ Gilden} sowie
   \item \enquote{\uline{RF III} -- Gilden komplettieren (AL) $\rightarrow$}
\end{itemize}

\noindent Die erste dieser Seiten beinhaltet eine nummerierte Liste, verfasst mit dem oben bereits angesprochenen ursprünglich wohl schwarzen Stift.
Die übrigen drei Seiten, beschrieben mit einem schwarzen Kugelschreiber, werden von losen Stichpunkten und Pfeildiagrammen dominiert.


% ORPHEUS – DOKUMENTE – WERDEGANG %
Den \enquote{\uline{Werdegang eines SC's}} finden wir auf einem beidseitig beschriebenen Blankobogen, wobei jede Seite mit

\begin{itemize}
   \item \enquote{\uline{Der Werdegang eines SC's}} und
   \item \enquote{\uline{Werdegang eines SC's} -- II}
\end{itemize}

\noindent eine eigene Überschrift trägt.
Die Vorderseite wird fast vollständig von einer nummerierten Liste gefüllt, abermals mit dem ursprünglich wohl schwarzen Stift verfasst.
Im oberen Drittel der Rückseite finden wir ein mit blauem Fineliner erstelltes Pfeildiagramm.


% ORPHEUS – DOKUMENTE – BEWEGUNGEN %
Die \enquote{\uline{\textsc{Bewegungen}}} umfassen einen einseitig mit Bleistift beschrifteten Blankobogen sowie zwei karierte Blätter -- eines davon doppelseitig beschrieben --, auf denen noch schwach ein Marginalsteg an der linken Seite zu erkennen ist.
Diese drei Seiten sind einmal mehr von dem mittlerweile ins Braune tendierenden Fineliner geprägt; von späterer Hand stammen Hinzufügungen in roter und blauer Farbe sowie mit Bleistift.
Während die erste Seite fast vollständig von einer Auflistung mit Spiegelstrichen gefüllt wird, weisen die Folgeseiten eine abweichende Organisation auf:
Sie sind durch horizontale Trennlinien in jeweils vier bis fünf Blöcke partitioniert.
Innerhalb der jeweiligen Blöcke werden unterschiedlichen Gruppen interner Animationsbezeichnungen (beispielsweise \enquote{1SA00}) verschiedene Informationen zuordnet.
...
Dass es sich in zumindest einem Fall um einen beidseitig beschriebenen Bogen handelt, wird durch die durchscheinende Beschriftung der Gegenseite deutlich.
Hinter der Überschrift ist in roter Farbe von späterer Hand der Hinweis \enquote{V1} ergänzt worden.
Anders als bei \enquote{\textsc{Orpheus} -- Spielwelt/Gildensystem} scheint hier aber keine zweite Version erhalten zu sein. % Mike fragen
Die ersten drei Seiten sind überwiegend durch (numerische oder alphabetische) Aufzählungen organisert; die verbleibenden Seiten enthalten demgegenüber lose Notizen und Skizzen.


% ORPHEUS – DOKUMENTE – GILDENSYSTEM %
Bei \enquote{Spielwelt/Gildensystem} und \enquote{Spielwelt/Gildensystem V2} handelt es sich um zwei Fassungen eines ursprünglich auf Blankopapier entworfenen und dann mehrfach kopierten Formulars, das Felder für verschiedene Aspekte der unterschiedlichen Fraktionen enthält.
Beide Versionen werden horizontal durch jeweils eine mit dem Lineal gezogene Linie als Kopf- und Fußzeile eingefasst, die -- in der Kopfzeile -- nur durch den Titel des Dokuments und -- in der Fußzeile -- durch den Hinweis \enquote{Autor: M. Hoge} unterbrochen werden.
Der frühere Entwurf enthält insgesamt elf Felder, zwei davon -- das Feld für den Namen der \enquote{\textsc{Gilde}} sowie das Feld für ihr \enquote{\textsc{Lernprogramm}} -- fein säuberlich unterstrichen, die sich in den oberen beiden Dritteln des Blatts ballen.
Erhalten sind hier eine unausgefüllte sowie fünfzehn mit Bleistift beschriebene Kopien.
Hier finden wir Einträge für

\begin{itemize}
   \item \enquote{\uline{Junta}},
   \item \enquote{\uline{Kampfmagier}},
   \item \enquote{\uline{Alte Buddler}},
   \item \enquote{\uline{Mafiaschläger (Kämpfer)}},
   \item \enquote{\uline{Mafiaspitzel (Diebe)}},
   \item \enquote{\uline{Geheime Diebesgilde !}},
   \item \enquote{\uline{Heilmagier}},
   \item \enquote{\uline{noble Söldner}},
   \item \enquote{\uline{Erzdiebe}},
   \item \enquote{\uline{Sekten Novizen}},
   \item \enquote{\uline{Sekten Gurus}},
   \item \enquote{\uline{Tempelwache}},
   \item \enquote{\uline{Freie Buddler}},
   \item \enquote{\uline{Bodyguards}} und
   \item \enquote{\uline{Freie Diebe}}.
\end{itemize}

\noindent Die spätere Fassung reduziert die Felder auf insgesamt zehn, ergänzt dasjenige für die \enquote{\textsc{Beziehungen} zu anderen Gilden} dafür aber um eine Liste von insgesamt 16 Parteien, so dass sich zu jeder die jeweilige Haltung notieren lässt.
Hier liegen neben einer unausgefüllten insgesamt 13 -- wieder mit Bleistift beschriebene -- Kopien vor.
Sie umfassen

\begin{itemize}
   \item \enquote{\uline{Junta}},
   \item \enquote{\uline{Schläger}},
   \item \enquote{\uline{Spitzel}},
   \item \enquote{\uline{Kampfmagier}},
   \item \enquote{\uline{Heilmagier}},
   \item \enquote{\uline{Paladine}},
   \item \enquote{\uline{Erzdiebe}},
   \item \enquote{\uline{Fallensteller}},
   \item \enquote{\uline{Gurus}},
   \item \enquote{\uline{Novizen}},
   \item \enquote{\uline{Tempelwache}},
   \item \enquote{\uline{Beschwörer}} und
   \item \enquote{\uline{GH Diebesgilde}}.
\end{itemize}


% ORPHEUS – DOKUMENTE – ZUSAMMENFASSUNG %
Bei der \enquote{Zusammenfassung zum Orpheus-Konzept} handelt es sich aller Wahrscheinlichkeit nach um ein ursprünglich umfangreicheres Dokument, von dem nur noch der Abschnitt zu \enquote{\uline{Graphiken}} erhalten ist.\autocite[Vgl.][]{archive_orpheus_2024} % Mike fragen
Es steht vermutlich nicht nur alphabetisch am Ende:
Die Zusammenfassung -- oder was von ihr übrig ist -- stellt das einzige nicht handschriftlich verfasste Schriftstück in der Sammlung dar und ist auf den 12. Dezember 1996 datiert.\footnote{Die anderen Dokumente könnten dementsprechend etwas älter sein. Der in ihnen enthaltene Entwurf einer Karte (siehe \autoref{sec:orpheus_welt_karte}) wird beispielsweise auf das Vorjahr, also 1995, geschätzt; \autocite[vgl.][]{flosha_evolution_2024}}
...
Auf den -- etwas abweichend von der Zählung im \textit{Gothic Archive} -- ersten beiden davon, die nur als Schwarzweißkopie vorliegen, finden wir die Überschriften
...
Einer dritten, mit blauem Kugelschreiber beschriebenen Seite, folgt eine vierte Seite, auf der sich eine mit blauem Kugelschreiber gezeichnete und mit Bleistift ausgefüllte Tabelle findet, in der einige Zellen zusätzlich mit roter oder grüner Farbe umrandet sind.
...
% ORPHEUS – DOKUMENTE – NICHTSPIELERCHARAKTERE %
Bei dem nicht näher betitelten Dokument zu den Nicht-Spieler-Charakteren in den verschiedenen Fraktionen handelt es sich um insgesamt neun Seiten auf dem bekannten karierten Papier. % Mike fragen ob wirklich Orpheus zuzuordnen
Der Qualität (und Farblosigkeit) des Scans wegen lässt sich nicht mehr erkennen, womit die Notizen hier verfasst worden sind. % Mike fragen
Im Wesentlichen ist das Dokument nach Gruppierungen gegliedert, deren Namen eingerahmt hervorgehoben werden, und von denen sich ein bis zwei pro Seite finden.
Darunter folgen -- durch einen Doppelpfeil getrennt -- jeweils zwei Spalten zur Auflistungen möglicher Gruppenmitglieder.
Links des Pfeils steht dabei die generische (zum Beispiel \enquote{Meuchler}) oder spezifische (zum Beispiel \enquote{\enquote{das Ohr}}) Bezeichnung, rechts davon eine knappe Beschreibung (beispielsweise im Fall der Meuchler \enquote{fähige Schatten für Routinearbeiten} oder im Falle des Ohrs \enquote{Meisterspion spezialisiert auf Infobeschaffung; Auftraggeber}).\autocite[S.~2]{orpheus_nscs}
Es finden sich Abschnitte für

\begin{itemize}
   \item \enquote{Das Volk},
   \item \enquote{Die Schatten},
   \item \enquote{Söldner},
   \item \enquote{Erzbarone},
   \item \enquote{Kreis des Feuers},
   \item \enquote{Die Organisatoren},
   \item \enquote{Die Bauern},
   \item \enquote{Kreis des Wassers},
   \item \enquote{Die Garde},
   \item \enquote{Die Fallensteller},
   \item \enquote{Der Schürferbund},
   \item \enquote{Die Gurus},
   \item \enquote{Die Novizen} und
   \item \enquote{Die Templer}.
\end{itemize}
...
In der \enquote{Zusammenfassung} ist unter der Überschrift \enquote{\uline{Spielansicht}} festgehalten, dass zu dieser Zeit insgesamt drei verschiedene Kameraperspektiven angedacht waren.
...
\enquote{Steht die Figur mit dem Rücken zur Wand, sieht ihr die Kamera über die Schulter. Geht die Figur jetzt los[,] so folgt ihr die Kamera erst wieder, wenn die Figur 5m entfernt ist.}\autocite[S.~1]{orpheus_zusammenfassung_1996}
Eine dritte Variante war für den \enquote{Kampfmodus} (siehe auch \autoref{sec:orpheus_mechanik}) vorgesehen:

\begin{quote}
   Ist die Figur im Kampfmodus [???] und ist sie in Kampfreichweite eines Monsters (2,5~m oder so), so dreht sich die Kamera 90$^\circ$ gegen den Uhrzeigersinn.
   Die Kontrahenten werden jetzt von der Seite gezeigt.
   Ist der Kampf vorbei, so sieht man die Figur wieder von hinten.\footnote{\autocite[S.~1;]{orpheus_zusammenfassung_1996} die eckigen Klammern sind Teil des Originals.}
\end{quote}
...
Vorgesehen waren dafür \enquote{Kopf, Oberkörper, Unterleib, 2 Oberarme, 2 Unterarme, 2 Hände, 2 Oberschenkel, 2 Unterschenkel, 2 Füße}.\autocite[S.~1]{orpheus_zusammenfassung_1996}
...
Jede Animationsphase einer solchen Figur sollte \enquote{aus einem Gelenk-Animations-Modell (\textbf{GAM})} bestehen, das sich aus \enquote{19 Raumkoordinaten} sowie \enquote{15 Limbvektoren} zusammensetzt, wobei gelten sollte:
\enquote{Jede Koordinate legt eine Gelenkverbindung zwischen zwei Limbs fest.}\autocite[S.~1]{orpheus_zusammenfassung_1996}
Hält die Figur eine Waffe in der Hand, sollte eine zusätzliche Raumkoordinate an deren äußerem Ende (beispielsweise der \enquote{Schwertspitze}) sowie ein zusätzlicher Waffenvektor hinzukommen.\autocite[S.~1]{orpheus_zusammenfassung_1996}
...
Tatsächlich kommen, wie aus der Abbildung deutlich wird, bei Händen, Füßen und Kopf jeweils zusätzliche Punkte hinzu, nämlich \enquote{Zehen}, \enquote{Handfläche} sowie \enquote{Höchster Kopfpunkt}.\autocite[S.~4]{orpheus_zusammenfassung_1996}
Im Spiel sollte die Figur dann \enquote{aus GAM und Limbs \textbf{zusammengesetzt}} werden.\autocite[S.~1]{orpheus_zusammenfassung_1996}
...
\begin{quote}
   ...
   Es ist möglich, einer Spielfigur den Kopf abzuhacken, so daß er lustig durch die Gegend fliegt.\autocite[S.~1]{orpheus_zusammenfassung_1996}
\end{quote}


Unter \enquote{\uline{Getrennt animierte GAMS}} ist notiert, dass ein Gelenk-Animations-Modell aus vier einzelnen Segmenten bestehen sollte:
(1) \enquote{Beine und Unterleib}, (2) \enquote{Oberkörper und Kopf} sowie (3) \enquote{rechter Arm (Aktionsarm)} und \enquote{linker Arm (passiver Arm)}.\autocite[S.~2]{orpheus_zusammenfassung_1996}
...
\begin{quote}
   ...
   Der modulare Zusammenbau dieser Animationssequenzen verhindert einen GAM-Overkill, da angestrebt wird, Waffen in der Hand auch im Outsideview darzustellen.\footnote{\autocite[S.~2]{orpheus_zusammenfassung_1996}. Die Durchstreichung ist nachträglich mit Kugelschreiber erfolgt.}
\end{quote}
...
Es endet mit dem in Klammern gesetzten Kommentar: \enquote{hierzu später mehr, ich muß jetzt Tombraider [sic] spielen}.\autocite[S.~3]{orpheus_zusammenfassung_1996}
...
Hier tauchen dann neben dem Ziehen der Waffe (\enquote{Draw},\autocite[S.~2]{orpheus_bewegungen} \enquote{Bogen ziehen} und \enquote{Armbrust anlegen}\autocite[S.~4]{orpheus_bewegungen}) sowie der \enquote{At[tacke]} und der \enquote{Pa[rade]} unter anderem auch \enquote{Kür}, \enquote{Unterschläge} sowie \enquote{Ruhehaltung} beziehungsweise \enquote{Standpose}\autocite[S.~2]{orpheus_bewegungen} auf und das Bewegungsrepertoire wird um das Umdrehen (\enquote{Turn}) sowie um Seitwärtsbewegungen (\enquote{Strafe}) erweitert.\autocite[S.~3]{orpheus_bewegungen}
...
Dabei bezieht er sich vermutlich auf die kampferprobte Protagonistin der zwischen 1995 und 2001 gedrehten Fernsehserie \textit{Xena -- Die Kriegerprinzessin}, wobei nicht klar ist, welcher ihrer \enquote{Moves} hier gemeint ist. % Mike fragen
...
Zunächst sollten, wie wir unter \enquote{\uline{Diverse Meshes}} erfahren, die als Meshes abgespeicherten Limbs (siehe \autoref{sec:orpheus_darstellung_animation}) in verschiedenen Formen verfügbar sein und sich beliebig an einem Gelenk-Animations-Modell (GAM) kombinieren lassen:
...
Dementsprechend finden wir hier die Varianten \enquote{offen, geschlossen, hält sich fest}.\autocite[S.~2]{orpheus_zusammenfassung_1996}
...
\begin{quote}
   ...
   Mit dem Baukastensystem kann man Köpfe mit verschiedenen Frisuren oder Helmen mit gleichen Körpern kombinieren, und erhält so (in Verbindung mit unterschiedlichen Texturen) verschiedene Figuren.\autocite[S.~2]{orpheus_zusammenfassung_1996}
\end{quote}

Für jede Ausführung der Limb-Meshes sollte es dann \enquote{individuell auf das entsprechende Limb zugeschneidert[e]} Texturen geben, wodurch sich \enquote{auch hier (durch unterschiedliche Texturierung gleicher Meshes) durch das Baukastensystem Vielfalt erzeugen}\autocite[S.~2]{orpheus_zusammenfassung_1996} lässt, wobei zusätzlich alle \enquote{Körpertexturen mit Ausnahme von Händen und Füßen} in drei unterschiedlichen Varianten vorkommen sollten: \enquote{normal}, \enquote{verletzt} und \enquote{schwer verletzt}.\autocite[S.~3]{orpheus_zusammenfassung_1996}
...
\begin{quote}
   ...
   Bevor die Kopftextur auf das Kopf-Limb gemappt wird, wird diese aus Gesichtstextur und Kopftextur zusammengesetzt, um nicht für jedes Gesicht in Verbindung mit allen Frisuren und Helmen je eine komplette Kopftextur im Speicher ablegen zu müssen.\autocite[S.~2\,f.]{orpheus_zusammenfassung_1996}
\end{quote}
...
Bei den Texturen für andere Limbs wäre das vernachlässigbar: \enquote{Beim Oberkörper ist dieser Effekt nicht so schlimm.}\autocite[S.~2]{orpheus_zusammenfassung_1996}
...
Den Ausgangspunkt bildet die erste Skizze, in der wir die Spielfigur aus der Verfolgerperspektive im Zentrum des Bildschirms sehen (siehe \autoref{sec:orpheus_darstellung_kamera}).
...
Die Figur \enquote{\sout{Legt} Steckt [ihre] Waffen weg} und wäre am Ende der Kamerafahrt, wie die dritte Skizze zeigt, nicht mehr zentriert dargestellt, sondern an den linken Bildschirmrand verschoben, so dass rechts von ihr ausreichend Platz für die Darstellung des Inventars bleibt.
Im nun offenen Inventarbildschirm hätte wir also ein aktuelles \enquote{ingame \uline{pic}} unserer Figur sehen sollen, wobei offen bleibt, ob sich das Inventar -- wie im finalen Gothic -- über die weiterhin in Bewegung befindliche Spielwelt hätte legen oder -- wie das unterstrichene Wort \enquote{\uline{pic}} implizieren könnte -- ein statische Abbildung hätte zeigen sollen.\autocite[S.~7]{orpheus_interface}
...
In einer von späterer Hand wieder durchgestrichenen Sammlung an Stichpunkten zur Waffenauswahl ist \enquote{$_{\downarrow}^{\uparrow}$ Inventory Scroll} vermerkt (zur Steuerung siehe \autoref{sec:orpheus_mechanik_steuerung}).\autocite[S.~7]{orpheus_interface}
...
In seiner oberen Hälfte werden vier Kleidungs- oder Rüstungsteile dargestellt und von einer Wellenlinie umschlossen; ein Teil für den Kopf, eines für den Oberkörper, eines für die Beine sowie eines für die Füße.
Zwischen den Teilen für Kopf und Oberkörper ist etwas nach rechts versetzt ein kleiner, teilweise schraffierter \enquote{\textsc{Balken}} platziert, dessen Funktion nicht ersichtlich ist; vielleicht hätte er den Zustand eines Ausrüstungsteils indizieren sollen. % Mike fragen
...
In der unteren rechten Ecke der Skizze steht in einem kleinen Kasten \enquote{\textsc{Shortsword}}; vielleicht hätte hier die Bezeichnung des jeweils im Fokus befindlichen Gegenstands erscheinen sollen. % Mike fragen
...
Auf gleicher Höhe ist rechts außerhalb der Umrandung ein weiterer Kasten eingezeichnet, in dem -- ebenfalls diagonal -- \enquote{\textsc{Log}} geschrieben steht; rechts neben dem Kasten prangt ein dünnes Ausrufezeichen.\autocite[S.~7]{orpheus_interface}
Beides -- Kasten und Ausrufezeichen -- wird von einer Umrahmung an den Rest der Skizze angeschlossen, so dass es wie ein seitlicher Register-Reiter wirkt; eventuell hätte man von hier aus auf das Tagebuch wechseln können sollen.
...
Ein Pfeil deutet darauf hin, dass sich unter den \enquote{\textsc{Pers[onen]}} wiederum einen \enquote{Glücksritter} vermerkt sein könnte.\autocite[S.~2]{orpheus_der_rote}
...
Wenn wir im Folgenden von \enquote{Spielmechanik} sprechen, dann verstehen wir darunter -- relativ weit gefasst -- die Menge an Möglichkeiten, die Spieler:innen zur Verfügung gestellt wird, um mit Spielelementen interagieren zu können.\autocite[Vgl.][255]{jaervinen_games_2008}
...
\enquote{\uline{Outside View Only}},\footnote{Das steht in Konflikt mit den Ausführungen unter \enquote{\uline{Spielansicht}} in der \enquote{Zusammenfassung}, wonach auch eine Egoperspektive vorgesehen war; siehe \autoref{sec:orpheus_darstellung_kamera}.} \enquote{\uline{Tastatur Only} (evtl Maus Inventory \& \enquote{\uline{Fernklick}} Unterstützung)} sowie \enquote{Items = VOBs}.\footnote{\autocite[S.~1]{orpheus_interface}. \enquote{VOB} steht hier für \enquote{Virtuelles Objekt}; zur Rolle von VOBs bei Gothic \autocite[vgl.][]{wiki_vob}.}
Alle drei Punkte haben sich als für die Entwicklung von Gothic maßgeblich herausgestellt:
Den namenlosen Helden sehen wir immer aus der Verfolgerperspektive, die Steuerung unterstützt zwar rudimentäre Mauseingabe, bleibt in der Hauptsache aber auf die Tastatur fokussiert, und alle Gegenstände, die wir in der Spielwelt finden können, sind in der Engine als virtuelle Objekte angelegt.

Unter diesen drei wegweisenden Stichpunkten folgt eine von \enquote{a} bis \enquote{p} reichende Liste an Möglichkeiten, die Spieler:innen haben sollten:
...
An die Idee, zum Beispiel einen \enquote{Schrank [$\ldots$] verschieben}\autocite[S.~3]{orpheus_interface} zu können, reicht es jedenfalls nicht mehr heran.\footnote{An anderer Stelle finden wir einen Hinweis darauf, dass -- zumindest ausgewählte -- Objekte scheinbar auch zerstörbar sein sollten. \enquote{Container zerstören, \uline{sonst nichts}} könnte darauf hindeuten, dass der Inhalt von Behältern bei ihrer Zerstörung erhalten bleiben sollte; \autocite[S.~9]{orpheus_b_scribbles}.}
...
Über einen \enquote{General Button} schließlich hätte sich scheinbar ein \enquote{Kriegsrat} der Party einberufen lassen sollen.
Diese Befehle hätten sich wahrscheinlich jeweils auf ein einziges Mitglied der Gruppe bezogen.
...
\enquote{08/15 Items haben Gruppenflag.}\autocite[S.~9]{orpheus_b_scribbles}\footnote{Ein generelles Problem stellt das potentielle Verschwinden von Gegenständen dar, die zur Lösung des Spiels notwendig sind. An anderer Stelle notiert Mike Hoge entsprechend: \enquote{Spiellösungsrelevante Items müssen neu rein bei Verschwinden}; \autocite[S.~7]{orpheus_b_scribbles}.}
...
Es finden sich beispielsweise Überlegungen, dass die oben erwähnte Aufforderung \enquote{Folge} nicht funktionieren sollte, wenn sich ein Gruppenmitglied \enquote{außer Hörreichweite} befindet.
...
Der etwas kryptische Vermerk \enquote{Kritische Dialoge \textsc{nicht} Triggern wenn \uline{Party} $-$ NSC $=$ \uline{Mensch}!}\autocite[S.~9]{orpheus_b_scribbles} könnte unter Umständen so gelesen werden, dass ein wichtiger Dialog nicht ausgelöst werden sollte, wenn Teile der Gruppe zwar am entsprechenden Ort sind, der menschliche Spieler (\enquote{NSC $=$ Mensch}) aber fehlt (\enquote{$-$}); wobei man freilich darüber hinwegsehen müsste, dass \enquote{NSC} per Definition eigentlich einen Charakter beschreibt, der nicht der Spieler ist.\footnote{In eine ähnliche Richtung scheint der Hinweis zu gehen, dass eine \enquote{\uline{Veränderung}} der \enquote{\uline{Oberwelt}}, die durch ein gewisses \enquote{\uline{Event}} ausgelöst werden könnte, nur stattfinden sollte, wenn sich \enquote{A $+$ B [gemeinsam] in eine[r] Dungeon Session} befinden; \autocite[S.~8]{orpheus_b_scribbles}.} % Mike fragen
...
In einer Tabelle ist minutiös festgehalten, welche Art von Angriff welche Auswirkungen auf einen Gegner in welcher Distanz haben soll.\autocite[Vgl.][S.~4--5]{orpheus_kampfsteuerung}
Dabei wird unterschieden zwischen vier für den Nahkampf relevanten Distanzen, vier möglichen Tastatureingaben (\enquote{\textsc{Ctrl}} in Kombination mit \enquote{$\uparrow$}, \enquote{$\rightarrow$}, \enquote{$\leftarrow$} oder \enquote{$\downarrow$}) sowie einem Angriff mit der \enquote{Faust} oder mit einer von drei Waffenarten (\enquote{Dolch}, \enquote{Schwert} und \enquote{Zweihänder}), mit denen man entweder geübt oder ungeübt sein kann, was in einer Tabelle mit immerhin 112 Zellen resultiert.\autocite[S.~4]{orpheus_kampfsteuerung}
...
In \enquote{\textsc{Orpheus. B -- Scribbles}} sind neben \enquote{Mut}, \enquote{\textsc{Ausdauer}} und \enquote{\textsc{Mana}} die Abkürzungen \enquote{STR}, \enquote{Ka GE}, \enquote{Di GE}, \enquote{A Ga}, \enquote{WIL}, \enquote{CON}, \enquote{AT}, \enquote{GE}, \enquote{TP}, \enquote{WK}, \enquote{DK}, \enquote{LP} und \enquote{WS} notiert.\autocite[S.~8]{orpheus_b_scribbles}
Flosha hat sich ausführlich mit diesen Abkürzungen beschäftigt und schlüsselt sie wie folgt auf:
\enquote{STR} steht für \enquote{Strength}, \enquote{Ka GE} für \enquote{Kampfgeschick}, \enquote{Di GE} für \enquote{Diebesgeschick}, \enquote{A Ga} für \enquote{Arkane Gabe}, \enquote{WIL} für \enquote{Wille}, \enquote{CON} für \enquote{Constitution}, \enquote{AT} für \enquote{Attack}, \enquote{GE} für \enquote{Geschicklichkeit}, \enquote{TP} für \enquote{Trefferpunkte}, \enquote{WK} für \enquote{Waffenkunst}, \enquote{DK} für \enquote{Diebeskunst}, \enquote{LP} für \enquote{Lebenspunkte} und \enquote{WS} entweder für \enquote{Willensstärke} oder \enquote{Wahnsinn}.
...
In einem Kasten\autocite[S.~8]{orpheus_b_scribbles} finden wir beispielsweise folgende beiden Spalten:
...
\vspace{1em}
\noindent Rechts daneben\footnote{\autocite[S.~8]{orpheus_b_scribbles}. Eine dritte Liste finden wir in den Notizen zu Zaubersprüchen, die wahrscheinlich nach der Orpheus-Phase entstanden sind (siehe auch \autoref{sec:phoenix_zauber}). Dort sind untereinander notiert: \enquote{ST}, \enquote{KON}, \enquote{We}, \enquote{DK}, \enquote{WK}, \enquote{SK}, \enquote{AG}, \enquote{WIL}, \enquote{CH} und \enquote{Wa}; \autocite[S.~8]{gothic_spells}.} wiederum ist notiert:
...
Während \enquote{Telekinetic Storm} erst mit dem 2015 für \textit{Pathfinder} erschienenen Quellenbuch \textit{Occult Adventures} als populärer Zauberspruch in Erscheinung zu treten scheint,\autocite[Vgl.][S.~188]{bulmahn_pathfinder_2015} kennen wir \enquote{Levitation} ebenfalls aus \textit{Advanced Dungeons \& Dragons} (dort als \enquote{Levitate} beziehungsweise \enquote{Schweben}).\footnote{\autocite[Vgl.][S.~143]{cook_adnd_1989}, sowie \autocite[S.~186]{cook_adnd_1996}.} % Mike fragen, woher Telekinetic Storm stammt
...
Wir finden ferner einige körperliche beziehungsweise auf Bewegung bezogene Fähigkeiten wie \enquote{Akrobatischer Sprung},\footnote{\autocite[Vgl.][S.~9]{orpheus_gildensystem}; vermutlich identisch mit \enquote{Akrobatik}; \autocite[S.~14]{orpheus_b_scribbles}.} \enquote{klettern}\autocite[S.~9]{orpheus_gildensystem} oder \enquote{Schwimmen}, \autocite[S.~14]{orpheus_b_scribbles} die uns auch in \textit{Advanced Dungeons \& Dragons} begegnen (\enquote{klettern} dort als \enquote{Mountaineering} beziehungsweise \enquote{Bergsteigen}).\footnote{\autocite[Vgl.][S.~61, 64]{cook_adnd_1989}, sowie \autocite[S.~79, 83\,f.]{cook_adnd_1996}.}
...
In den Notizen zur Kampfsteuerung (siehe auch \autoref{sec:orpheus_mechanik_steuerung}) erfahren wir außerdem, dass es sowohl für \enquote{Dolch}, \enquote{Schwert} als auch \enquote{Zweihänder} jeweils ein \enquote{\textsc{Talent}} geben sollte.\footnote{\autocite[S.~4\,f.;]{orpheus_kampfsteuerung} siehe auch \enquote{\uline{\textsc{Talent} (Schwertk.)}}; \autocite[S.~1]{orpheus_kampfsteuerung}.}
...
Petra Schmitz, die das Spiel vor seiner Veröffentlichung für die \textit{GameStar} bei einem Preview-Termin hatte anspielen können, erinnert sich daran, wie schockiert sie davon war, dass das Spiel zu diesem Zeitpunkt keine Maussteuerung unterstützt hat.\autocite{schmitz_maussteuerung_2021}
Die oben erwähnte Notiz \enquote{\uline{Tastatur Only}}\autocite[S.~1]{orpheus_interface} (siehe  \autoref{sec:orpheus_mechanik_möglichkeiten}) sollte bei der Entwicklung bis zum Schluss richtungsweisend bleiben, auch wenn vor Veröffentlichung noch die Verarbeitung von Mauseingaben eingearbeitet wurde.

Ein zentrales Element der Steuerung im finalen Gothic ist die Steuerungstaste (kurz \enquote{Strg}).
...
Mit gezogener Waffe (oder gehobenen Fäusten, wenn wir keine Waffe ausgerüstet haben) können wir dann durch Strg im Kombination mit W, A oder D angreifen, während uns Strg und S blocken lässt.
Diese Kombination von Steuerungs- und Richtungstasten geht -- wie wir oben im Zusammenhang mit der Tabelle gesehen haben -- ebenso auf diese frühe Phase zurück (siehe auch \autoref{sec:orpheus_mechanik_möglichkeiten}).
Den Notizen zur Kampfsteuerung zufolge sollte durch die Kombination von Strg und Pfeiltasten entweder unterschiedliche Gegner angegriffen oder verschieden Schwertstreiche auf den gleichen Gegner ausgeführt werden können.\footnote{\autocite[Vgl.][S.~1--3]{orpheus_kampfsteuerung}; siehe auch \autocite[S.~4]{orpheus_interface}, wo wir ein Raster aus $3 \times 3$ Tasten finden, die in Kombination mit \enquote{Fire} jeweils unterschiedliche Aktionen im Kampf bewirken sollten. Von link nach Rechts sind das in der obersten Reihe \enquote{Tritt}, \enquote{Stechen} und Schlag von \enquote{Oben}, in der mittleren Reihe \enquote{L[inks] Seitlich [schlagen]}, \enquote{Barbarenschlag} und \enquote{R[echts] Seitlich [schlagen]} sowie in der unteren Reihe \enquote{L[inks] Rumgehen}, \enquote{Hinter Schlag} und \enquote{R[echts] Rumgehen}. Dieses Raster ist schon auf S.~1 hinter Punkt (a) \enquote{div[erse] Schläge} angedeutet.}
...
Welchen Herausforderungen man sich mit diesem Repertoire an spielerischen Möglichkeiten hätte stellen können sollen, verraten zwei mit \enquote{\uline{Aufträge}} überschriebene Seiten (siehe \autoref{fig:orpheus_auftraege}; zu weiteren Ideen für Aufträge siehe auch \autoref{sec:orpheus_geschichte_abschnitte}).
Neben der Überschrift ist die Devise \enquote{\uline{Jagen \& sammeln} (\uline{Wenig} Detektivaufträge)} vermerkt.\autocite[S.~16]{orpheus_b_scribbles}
...
\begin{quote}
   \begin{itemize}
      ...
      \item[20)] Ich will überlaufen! (2 Slots besezt [sic] / 1 immer besetzt)
      \item[21)] Muß was klauen, aber es ist schon ein Dieb da... [neuer Auftrag]
      \item[22)] Belausche Gespräch, \uline{mich} kennen die beiden\footnote{\autocite[S.~16\,f.;]{orpheus_b_scribbles} das zweite Paar eckiger Klammern ist Teil des Originals.}
   \end{itemize}
\end{quote}

Am Ende der zweiten Seite wird eine Klassifizierung der Aufträge in sechs \enquote{\uline{Typ[en]}} versucht:
\enquote{Item finden}, \enquote{Item von Person bringen}, \enquote{Schutzpatroullie [sic]}, \enquote{Töte X}, \enquote{Massenangriff} (oder -- hier ist die Handschrift etwas uneindeutig -- \enquote{Messerangriff}) sowie \enquote{Schmiere stehen}.\autocite[S.~17]{orpheus_b_scribbles}
...
An anderer Stelle, unter der Überschrift \enquote{\textsc{Orpheus} -- \uline{Übersicht}}, werden drei weitere \enquote{\uline{Motivation[en]} für Aufträge} genannt, nämlich \enquote{Machtkämpfe}, \enquote{Vergünstigungskämpfe} und \enquote{Person entführt}.\autocite[S.~12]{orpheus_b_scribbles}

Auch eine Einbindung in die Spielwelt (siehe \autoref{sec:orpheus_welt}) findet sich schon stellenweise.
Es wird direkt Bezug genommen auf den Sumpf, das Lager der Psioniker sowie deren Tempel (bei 10, 15 und 9), auf die Arena (bei 16), das Buddlerfort (bei 13), auf die Mienen und spezifisch auf die alte Miene (bei 3 und 5), auf Höhlen unter den Äckern (bei 6) sowie auf einen alten Tempel (bei 7).
...
Unter der Überschrift \enquote{\textsc{Orpheus} -- \uline{Übersicht}} finden wir den vielleicht ersten Entwurf einer Karte der Kolonie überhaupt (siehe \autoref{fig:orpheus_karte_1}), der auf 1995 geschätzt wird.\autocite[Vgl.][]{flosha_evolution_2024} % Bei Mike nachfragen
Rechts neben sowie unter der Karte finden wir drei unterstrichene Stichpunkte: \enquote{\uline{1 Palette}} (gemein ist vielleicht eine Farbpalette), \enquote{\uline{1 Texturenpool}} und \enquote{\uline{nicht zu groß}}.\autocite[S.~11]{orpheus_b_scribbles}
...
Auffällig ist außerdem, dass die Barriere in dieser frühen Form als eine Art magische Wand gedacht gewesen zu sein scheint, wie beispielsweise in John Carpenters \textit{Escape from New York}, in dem ganz Manhattan in eine Gefängniskolonie umgewandelt wurde, die vollständig von einer 50 Fuß hohen Mauer umgeben ist.
Darauf deutet nicht nur eine kleine Skizze rechts unterhalb der Karte hin, auf der die Barriere nach oben wie nach unten begrenzt ist, sondern auch zwei Hinweise, die wir in \enquote{\textsc{Orpheus} -- Spielwelt/Gildensystem} (siehe \autoref{sec:orpheus_welt_fraktionen}) finden.
Dort ist als \enquote{\textsc{Ausbruchsplan}} für die \enquote{Mafiaschläger} notiert:
\enquote{Träumen davon[,] eines Nachts die Klippe im Sturm zu nehmen}.\autocite[S.~4]{orpheus_gildensystem}
Und bei den \enquote{Freie[n] Buddler[n]} heißt es:
\enquote{Versuchen sich unter der Barriere durchzubuddeln}.\autocite[S.~13]{orpheus_gildensystem}
Eine weitere Möglichkeit, die Barriere zu überwinden, wird unter \enquote{\textsc{Orpheus -- Kreaturen}} angesprochen.
Hier steht, \enquote{\uline{Greife} landen $1 \times$ im Jahr $\rightarrow$ \uline{Escape}} und \enquote{Leute stehen auf Wiese und warten} auf die Ankunft der Greife.\autocite[S.~4]{orpheus_b_scribbles}
Es klingt also ganz so, als sei die Barriere in ihrer vertikalen Ausdehnung zu diesem Zeitpunkt als begrenzt und damit -- wenn man nur tief oder hoch genug kommt -- als überwindbar konzipiert gewesen.
Und während wir im fertigen Spiel noch einige Meter weit laufen können, nachdem wir die Barriere passiert haben, ehe uns ein Blitz niederstreckt, deutet eine kleine Skizze unterhalb der Karte darauf hin, dass sie ursprünglich vielleicht als weniger durchlässig gedacht war.
Hier sehen wir ein \enquote{Orkskelett}, das \enquote{in [der] \uline{Barriere}} zu stecken scheint.\autocite[S.~11]{orpheus_b_scribbles}
...
Auch das Alte Lager, für viele Spieler der erste Anlaufpunkt nach ihrem Sturz in den See, befindet sich schon im Zentrum der Karte, hier als \enquote{\enquote{Liberales} Lager}. % Mike fragen, warum »Liberal«
Es ist bereits erkennbar, dass es über einen inneren und einen äußeren Teil verfügen sollte, wie wir auch \enquote{\textsc{Orpheus -- Locations}} entnehmen können, wo festgehalten ist, dass den \enquote{\uline{Kern}} des Lagers ein \enquote{altes Aufseherhaus (\uline{relativ} protzig)} bilden sollte, um das herum wir die \enquote{Outskirts (Fort)}\autocite[S.~5]{orpheus_b_scribbles} -- an anderer Stelle unter der Bezeichnung \enquote{äußerer Ring}\autocite[S.~19]{orpheus_b_scribbles} -- finden.
Besser erkennbar ist das auf der Rückseite des Blattes, auf der wir eine detailliertere Darstellung des Lagers finden (siehe \autoref{fig:orpheus_karte_2}).
...
Um dieses Zentrum herum finden wir, geschützt durch eine \enquote{äußere Befestigung}, ein Viertel für die \enquote{Diebe}, eines für die \enquote{Söldner}, mit einer \enquote{Arena} in seiner Mitte, sowie ein \enquote{08/15}-Viertel,\autocite[S.~12]{orpheus_b_scribbles} das an anderer Stelle als \enquote{größtes Viertel}\autocite[S.~14]{orpheus_b_scribbles} bezeichnet wird.
Eine kleine vertikale Querschnittsskizze unterhalb der Karte des Lagers verrät uns außerdem, dass dort, wo sich im fertigen Spiel die Kerker der Burg befinden, ursprünglich eine \enquote{Kanal[isation]} sein sollte.\autocite[S.~12]{orpheus_b_scribbles}
...
Entsprechend ist über der Karte mit vorangestellten Blitz noch das Problem notiert:
\enquote{Wasserversorgung?}\autocite[S.~11]{orpheus_b_scribbles}

Statt in den südwestlichen Bergen finden wir die Orks -- hier als \enquote{\uline{Halborks}}\autocite[S.~11]{orpheus_b_scribbles} -- mitten in diesem Wald.
Aus einer kleinen vertikalen Querschnittsskizze rechts unterhalb der Karte ist aber ersichtlich, dass sie auch, was im fertigen Spiel nur teilweise zutrifft, unterirdisch hausen sollten.
Entsprechend finden wir in \enquote{\textsc{Orpheus -- Locations}} auch den Stichpunkt \enquote{\uline{Orkhöhle} (Dorf)}.\autocite[S.~5]{orpheus_b_scribbles}
...
Von späterer Hand ist am unteren Rand der Karte außerdem vermerkt:
Das \enquote{\textsc{Erz} interessiert [die] Orks \uline{nicht}}.\autocite[S.~11]{orpheus_b_scribbles}
...
Daneben gibt es noch das Sektenlager, vermerkt als \enquote{\textsc{Psi} (Tempel)}, im Nordosten, sowie \enquote{\uline{Magier}} im Südosten, jeweils nah am Rand des großen Waldes gelegen, der zwischen den Beiden Orten noch weiter in die Kolonie hereinreicht, so dass man ihn auf dem Weg vom Tempel im Norden zu den Magiern im Süden umgehen müsste, wenn man sich nicht in ihn hineinwagen möchte.\autocite[S.~11]{orpheus_b_scribbles}
...
\begin{quote}
   \begin{itemize}
      \item[1)] Außenwelt
      \item[2)] Bonzo's Gladiatorenlager % Mike fragen, wer Bonzo war
      ...
      \item[9)] \uline{Orkhöhle} (Dorf)\autocite[S.~5]{orpheus_b_scribbles}
   \end{itemize}
\end{quote}
...
Die Idee der verschiedenen Lager und der unterschiedlichen Gruppierungen, denen man sich als Spieler anschließen kann, entstand schon früh während der Konzeptionsphase.
...
Daneben hätte es noch ein \enquote{08/15}-Viertel geben sollen,\footnote{\autocite[S.~4]{orpheus_gildensystem}, \autocite[S.~12, 14\,f.]{orpheus_b_scribbles}.} das -- wie wir anhand anderer Notizen sehen -- für \enquote{Gildenlose}\autocite[S.~15]{orpheus_b_scribbles} vorgesehen war.
...
Während sie \enquote{[v]on allen AL-Bewohnern respektiert} werden, sind sie die \enquote{Made im Speck in [dem] Zentrum des alten Lagers} und \enquote{nehmen nur SCs mit ungewöhnlichem magischen Talent} bei sich auf.
\enquote{Dies \enquote{\uline{erkauft}} sich der SC bei \uline{Lehrern}}
Eine Chance zum Ausbruch sehen die Kampfmagier darin, \enquote{evtl. [ein] Magisches [sic] Portal [zu] erschaffen}.
Da es ihnen aber eigentlich ganz gut geht, wird dieser \enquote{Plan eher sporadisch verfolgt}.\autocite[S.~2]{orpheus_gildensystem}
...
Die Junta \enquote{[m]anipuliert manchmal Arena-Wetten}.
Einen Ausbruchsplan verfolgt sie nicht, denn auch \enquote{[d]er Mafia geht es gut}.\autocite[S.~1]{orpheus_gildensystem}

Die Mafiaschläger ihrerseits \enquote{\uline{Verteidigen} Altes Lager, Altes Buddlerfort und Buddler bei der Arbeit}.
Außerdem sind sie die \enquote{Arenavorsitzende[n]} und \enquote{bedrohen [das] 08/15-Viertel $\rightarrow$ \enquote{Schutzgeld} für die Mafia}.
Wenn es darum geht, aus der Kolonie zu entkommen, \enquote{[t]räumen [sie] davon[,] eines Nachts die Klippe im Sturm zu nehmen}; ein Hinweis darauf, dass die Barriere nicht von Anfang an als Kugel gedacht war (siehe auch \autoref{sec:orpheus_welt_karte}).
Bei der Rekrutierung sind sie nicht zimperlich:
\enquote{Die Schläger nehmen alles auf, was sich behaupten kann und nicht in Verdacht steht ein Verräter zu sein.}
Ob sich jemand behaupten kann, hätte wohl ein Kampf in der Arena zeigen sollen; unter \enquote{\textsc{Eintrittsvoraussetzungen}} notiert Mike Hoge:
\enquote{Kampf XP $\rightarrow$ \uline{Arenakampf}}.\autocite[S.~4]{orpheus_gildensystem}

Bei den Mafiaspitzeln wiederum handelt es sich um eine \enquote{kl[eine,] lose Gruppierung}.
Ihnen ist das \enquote{Diebesviertel} gewidmet, aber sie \enquote{lungern} auch im \enquote{Aussenbereich überall rum}.
Im Lager fungieren sie als \enquote{Mafia-Informanten} und \enquote{handeln mit Infos}.
Außerdem bekommen sie \enquote{kleine Meuchelaufträge von [der] Mafia}.
Die \enquote{Gildenoberhäupter dürfen ins AL-Zentrum}; ein Privileg, das dem Spieler zu Anfang noch nicht gegeben ist.
Hat er wichtige Informationen, muss er sie stattdessen an besagte Oberhäupter geben (\enquote{kl. SC-Dieb gibt Infos an Oberhäupter}).
Dabei handelt es sich um \enquote{3 Diebe[,] die kl. Diebe um sich scharen}.
Wer den Spitzeln beitreten möchte, muss eine \enquote{Aufnahmeprüfung (Auftrag)} bestehen:
\enquote{Bei erfüllter Mission \textsc{Angebot} der Mitgliedschaft}.\autocite[S.~5]{orpheus_gildensystem}

Bleiben noch die Buddler des Alten Lagers.
Bei ihnen handelt es sich um eine mittelgroße Gruppe (\enquote{Mittlere Gruppierung}), deren Funktion darin besteht, das magische Erz zu fördern, das vom Alten Lager anschließend mit der Außenwelt gegen Waren eingetauscht wird; von ihrem eigenen Anteil haben die Buddler außerdem etwas als Schutzgeld abzugeben (\enquote{schürft Erz $\rightarrow$ Mafia $\leftrightarrows$ AW} und \enquote{Teil der Erträge = Schutzgeld}).
Oben auf dem Blatt, über \enquote{\textsc{\uline{Gilde}}} und \enquote{Hauptsïtz}, ist -- von späterer Hand und mit rotem Filzstift -- vermerkt:
\enquote{\textsc{Interne Gilde} -- Lernen über \textsc{Lehrer}}.
Der ursprüngliche Eintrag \enquote{\sout{3: Für alle Gilden}} in dem Feld \enquote{\textsc{Exclusiv ab Level}} ist -- mit Bleistift -- wieder durchgestrichen worden.
Es sieht also ganz danach aus, als wäre relativ früh die Entscheidung gefallen, dass die Buddler des Alten Lagers keine Fraktion sind, der man sich anschließen können soll.
Die beiden Fähigkeiten \enquote{Gänge freilegen} und \enquote{\uline{eingestürzte} Gänge freilegen}, die unter \enquote{\textsc{Lernprogramm}} notiert sind, sollten aber scheinbar trotzdem noch durch Lehrer erlernbar sein.\autocite[S.~5]{orpheus_gildensystem}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ORPHEUS – SPIELWELT – FRAKTIONEN – NEUES LAGER %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Neues Lager}\label{sec:orpheus_welt_fraktionen_neues}
...
Die Heilmagier können nicht nur heilen, sondern \enquote{erwecken Tote gegen [Geld] oder Auftrag}.\footnote{Die eckigen Klammern sind Teil des Originals.}
...
Dabei handelt es sich um eine \enquote{kollektive Anstregung aller} Heilmagier.
Sie \enquote{\uline{[f]orschen} nach [einem] optimalen Spruch}.
Möchte der Spieler sich den Heilmagiern anschließen, \enquote{muß [er den] \textsc{Cure}-Spruch beherrschen}.
Macht dem Spieler das Probleme, erweisen sich die Magier als wenig freundlich; \enquote{versagt er dabei, wird er vom Hof gejagt.}
Damit ist dieser Weg aber noch nicht verbaut:
Eine \enquote{2. Chance wird durch [einen] Computerforcieten [sic] NSC-Dialog angekündigt}.\autocite[S.~7]{orpheus_gildensystem}
...
Aus den noblen Söldnern werden die \enquote{Paladine} und statt der freien Diebe finden wir nun die \enquote{Fallensteller}.\footnote{Später wird diese Idee wieder gestrichen. In \enquote{\textsc{Orpheus. B -- Scribbles}} ist notiert: \enquote{\uline{Fallensteller raus}}.}
...
\begin{quote}
   ...
   \begin{itemize}
      ...
      \item[--] Lernprogramm!
      \item[--] \sout{Ausbruchsplan}\footnote{Die eckigen Klammern sind Teil des Originals; vermutlich wurde dieser Punkt im Nachhinein ergänzt.}
   \end{itemize}
\end{quote}
...
\begin{quote}
   \begin{itemize}
      ...
      \item[--] \uline{Medizin}!
      \item[--] leckeres Essen
      \item[--] Alkohol\footnote{\autocite[S.~13]{orpheus_b_scribbles}. Sowohl \enquote{leckeres Essen} als auch \enquote{\textsc{Drogen}} aus der Außenwelt werden außerdem erwähnt in \enquote{\textsc{Orpheus -- History}}; \autocite[S.~2]{orpheus_b_scribbles}. Auf Medizin aus der Außenwelt ist das Alte Lager angewiesen, da die Heilmagier nur im Freien Lager wirken; \autocite[vgl.][S.~7]{orpheus_gildensystem}.}
   \end{itemize}
\end{quote}
...
\begin{quote}
   \begin{itemize}
      ...
      \item[--] Haus reparieren (Hämmern)\footnote{Die eckigen Klammern sind Teil des Originals.}
   \end{itemize}
\end{quote}
...
Er soll \enquote{Wenig quatschen/rumfragen} und es gilt: \enquote{\uline{Auftraggeber} sprechen Dich \sout{an} (\uline{keine} Frageorgie!)}.\footnote{Über dem durchgestrichenen \enquote{\sout{an}} ist notiert: \enquote{1 * an} und \enquote{danach selber}. Vermutlich also: Der Spieler hat zu warten, bis er das erste Mal von einem potentiellen Auftraggeber angesprochen wird. Erst danach ist er in der Position, seinerseits den Auftraggeber anzusprechen.}
